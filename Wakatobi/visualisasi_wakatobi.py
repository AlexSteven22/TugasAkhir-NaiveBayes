...
# Load data
file_path = r'E:\IPEN\Semester 7\TA\Simulasi - Augment\Wakatobi Augment\data_wakatobi - visualisasi.xlsx'
...
custom_stopwords = {
    ...
    'orang','perahu','sayang','masih','agak','gk','perlu','lengkuas', 'wakatobi',
    'atau','harus','salah','satu','anda','kita','kami','saya','kamu','nya','sini', 'sedikit',
    'apa', 'tuk', 'besar', 'lihat', 'air', 'benar', 'tempat', 'mulai','sana','biasa',
    'bawah','laut','taman','nasional'
}
...
plt.tight_layout()
plt.savefig(r"E:\IPEN\Semester 7\TA\Simulasi - Augment\Wakatobi Augment\wordcloud_wakatobi.png", 
            dpi=300, 
            bbox_inches='tight')
plt.show()
