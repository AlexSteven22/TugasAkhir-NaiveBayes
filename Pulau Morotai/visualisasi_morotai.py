...
# Load data
file_path = r'E:\IPEN\Semester 7\TA\Simulasi - Augment\Morotai Augment\data_morotai - visualisasi.xlsx'
...
custom_stopwords = {
    'pulau','pantai', 'morotai','sangat','kurang','tempat','sungguh','lalu','banget', 
    'banyak','kota','lebih','wisata', 'sejarah', 'dunia', 'perang','kunjung','nya', 'sekali'
}
...
plt.tight_layout()
plt.savefig(r"E:\IPEN\Semester 7\TA\Simulasi - Augment\Morotai Augment\wordcloud_morotai.png", 
            dpi=300, 
            bbox_inches='tight')
plt.show()
