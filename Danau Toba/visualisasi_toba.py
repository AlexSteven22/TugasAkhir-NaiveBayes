...
# Load data
file_path = r'E:\IPEN\Semester 7\TA\Simulasi - Augment\Toba Augment\data_toba - visualisasi.xlsx'
...
custom_stopwords = {
    ...
    'orang','perahu','sayang','masih','agak','gk','tanjung','lengkuas', 'toba',
    'atau','harus','salah','satu','anda','kita','kami','saya','kamu','nya','sini', 'danau',
    'apa', 'tuk', 'besar', 'samosir', 'lihat', 'air', 'benar', 'tempat', 'mulai'
}
...
plt.tight_layout()
plt.savefig(r"E:\IPEN\Semester 7\TA\Simulasi - Augment\Toba Augment\wordcloud_toba.png", 
            dpi=300, 
            bbox_inches='tight')
plt.show()
