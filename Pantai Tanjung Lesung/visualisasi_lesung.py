...
# Load data
file_path = r'E:\IPEN\Semester 7\TA\Simulasi - Augment\Tanjung Lesung Augment\data_lesung - visualisasi.xlsx'
...
custom_stopwords = {
    ...
    'dari', 'dengan', 'untuk', 'pada', 'dalam', 'juga', 'karena', 'banyak', 'sana',
    'tempat', 'lokasi', 'area', 'kami', 'sudah', 'hanya', 'terlalu', 'bisa', 
    'jadi', 'seperti', 'cukup', 'lebih', 'kurang', 'wisata', 'pantai', 'tapi',
    'orang','perahu','sayang','masih','agak','gk','tanjung', 'lesung',
    'atau','harus','salah','satu','anda','kita','kami','saya','kamu','nya','sini', 'danau',
    'apa', 'tuk', 'besar', 'lihat', 'air', 'benar', 'tempat', 'mulai', 'perlu', 'laut', 'bawah',
    'sedikit', 'taman', 'nasional', 'masuk', 'ga', 'gak', 'banget', 'buat'
}
...
plt.tight_layout()
plt.savefig(r"E:\IPEN\Semester 7\TA\Simulasi - Augment\Tanjung Lesung Augment\wordcloud_lesung.png", 
            dpi=300, 
            bbox_inches='tight')
plt.show()