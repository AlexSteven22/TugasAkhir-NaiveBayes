...
df_train = pd.read_excel(r'E:\IPEN\Semester 7\TA\Simulasi - Augment\Tanjung Kelayang Augment\data_train_kelayang.xlsx')
df_test = pd.read_excel(r'E:\IPEN\Semester 7\TA\Simulasi - Augment\Tanjung Kelayang Augment\data_test_kelayang.xlsx')
...
output_excel_file = r'E:\IPEN\Semester 7\TA\Simulasi - Augment\Tanjung Kelayang Augment\output_augmented_and_predictions.xlsx'
...
output_file = r'E:\IPEN\Semester 7\TA\Simulasi - Augment\Tanjung Kelayang Augment\hasil_evaluasi_naive_bayes_augmented.txt'
